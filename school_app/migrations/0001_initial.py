    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('student', 'دانش\u200cآموز'), ('teacher', 'معلم'), ('admin', 'مدیر'), ('assistant', 'معاون')], default='student', max_length=10)),
                ('educational_base', models.CharField(choices=[('Electricity', 'برق'), ('Networks', 'شبکه'), ('Electronics', 'الکترونیک')], default='Networks', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='school_app.chatgroup')),
